...
#else
    [SerializeField]
    [Tooltip("Keyboard character to increase LOD level")]
    private string increaseLODLevelKey = "g";

    [SerializeField]
    [Tooltip("Keyboard character to derease LOD level")]
    private string decreaseLODLevelKey = "f";
#endif
#endif
...
#else
            if (Keyboard.current.FindKeyOnCurrentKeyboardLayout(increaseLODLevelKey)?.isPressed == true)
#endif
            {
                IncreaseLODLevel();
            }
...
#else
            if (Keyboard.current.FindKeyOnCurrentKeyboardLayout(decreaseLODLevelKey)?.isPressed == true)
#endif
            {
                DecreaseLODLevel();
            }
