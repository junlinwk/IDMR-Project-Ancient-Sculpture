...
namespace Oculus.Avatar2
{
    ...
    public class SampleCustomAnimationController : MonoBehaviour
    {
        ...
        {
#if ENABLE_INPUT_SYSTEM
            return Keyboard.current?.digit0Key?.wasReleasedThisFrame == true || Keyboard.current?.numpad0Key?.wasReleasedThisFrame == true
        ...
        {
#if ENABLE_INPUT_SYSTEM
            return Keyboard.current?.digit9Key?.wasReleasedThisFrame == true || Keyboard.current?.numpad9Key?.wasReleasedThisFrame == true
#else // !ENABLE_INPUT_SYSTEM
        ...
        {
#if ENABLE_INPUT_SYSTEM
            return Keyboard.current?.digit8Key?.wasReleasedThisFrame == true || Keyboard.current?.numpad8Key?.wasReleasedThisFrame == true
#else // !ENABLE_INPUT_SYSTEM
