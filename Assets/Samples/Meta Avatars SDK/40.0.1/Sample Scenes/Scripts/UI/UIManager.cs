...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("Unity event system game object that utilizes the legacy input system")]
    private GameObject? unityEventSystemGameObject;
    ...
    private void EnableEventSystemGameObject()
    {
        ...
        {
            OvrAvatarLog.LogError("Missing event system game object.");
            return;
        }

#if ENABLE_INPUT_SYSTEM
        unityEventSystemGameObject.AddComponent<InputSystemUIInputModule>();
#elif ENABLE_LEGACY_INPUT_MANAGER
        unityEventSystemGameObject.AddComponent<StandaloneInputModule>();
#endif
